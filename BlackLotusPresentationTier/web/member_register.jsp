...
<html>
    <head>
        ...
        <title>Black lotus - Member register</title>
        <style type="text/css">
            .register-form {
                width: 440px;
                margin: 50px auto;
    ...
    <body>
        ...
        <div class="register-form">
            <form class="text-center border border-light p-5" action="actions/register_action.jsp">
                <p class="h4 mb-4">Member Sign up</p>
