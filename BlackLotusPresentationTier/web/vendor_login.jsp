...
<html>
    ...
    <body>
        ...
        <div class="login-form">
            <h1 class="display-4">Vendor Login</h1>
            <form action="actions/vendor_login_action.jsp" method="post">
                ...
                <div class="clearfix">
                    <a href="vendor_forgot_password.jsp" class="pull-right">Forgot Password?</a>
                </div>    
